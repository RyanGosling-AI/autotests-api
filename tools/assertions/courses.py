...
def assert_create_course_response(
    ...
    """
    assert_equal(response.course.title, request.title, "title")
    assert_equal(response.course.max_score, request.max_score, "maxScore")
    assert_equal(response.course.min_score, request.min_score, "minScore")
    assert_equal(response.course.description, request.description, "description")
    assert_equal(response.course.estimated_time, request.estimated_time, "estimatedTime")
    assert_equal(response.course.preview_file.id, request.preview_file_id, "previewFileId")
    assert_equal(response.course.created_by_user.id, request.created_by_user_id, "createdByUserId")
